...
pipeline {
    ...
    post { 
        success {
            sshCommand remote: remote, command: "cd /home/testsite/Renders/jest-stare && ls && git init && git remote add pinaio https://github.com/alfajri31/pina.github.io.git && git commit -m 'update-euy' && git push pinaio master && git remote remove pinaio"
            echo 'I succeeeded!'
        }
        unstable {
            sshCommand remote: remote, command: "cd /home/testsite/Renders/jest-stare && ls && git init && git remote add pinaio https://github.com/alfajri31/pina.github.io.git && git commit -m 'update-euy' && git push pinaio master && git remote remove pinaio"
